...
function roleDisplayLabel(ctx: EmployeesContext | null) {
  if (ctx?.is_owner) return 'Owner';
  const area = ctx?.visible_areas?.[0];
    ...
    <div className="dtt-layout">
      <aside className="dtt-sidebar">
        ...
        <ul className="dtt-sidebar-nav">
          ...
          <li>
            <Link href="/payroll/employees" className="active">
              Employees
            </Link>
          </li>
          <li>
            <Link href="/payroll/owner/period">Period Review</Link>
          </li>
          <li>
      ...
      <div className="dtt-main">
        <div className="dtt-topbar">
          ...
          <div className="dtt-topbar-right">
            ...
            <span className="dtt-topbar-role">{roleDisplayLabel(ctx)}</span>
          </div>
        </div>
        ...
        <div className="dtt-breadcrumb">
          ...
          <span className="dtt-breadcrumb-sep">&gt;</span>
          <span className="dtt-breadcrumb-current">Employees</span>
        </div>
